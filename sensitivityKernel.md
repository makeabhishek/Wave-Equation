...
+ The sensitivity or Jacobian matrix or sensitivities or Frechet derivatives $S \in R^{N \times M}$ contains the partial derivatives of the model responses fi with respect to the model parameters $m_j$ [5]
...
[5] Günther, Thomas, Carsten Rücker, and Klaus Spitzer. "Three-dimensional modelling and inversion of DC resistivity data incorporating topography—II. Inversion." Geophysical Journal International 166.2 (2006): 506-517.
